...
.\build.ps1 -Name icons-iconoir -Version 1.2.3
```
...
```
<project>/.config/icons-iconoir/<packaging>.build-host
$HOME/.config/icons-iconoir/<packaging>.build-host
```
...
user: builder
shell: powershell
build_dir: C:/build/icons-iconoir
```
